export default {
  appName: "wolf",
  pkg: {
    ios: ["com.wolf.online.ios"],
    android: ["com.imbb.langrenOL.android"],
  },
  domain: "17hotplay.com",
  // 接口服务器协议
  protocol: {
    development: "https",
    production: "https",
  ...
  api_domain: {
    development: "https://dev.17hotplay.com",
    production: "https://api.17hotplay.com",
    alpha: "https://alpha.17hotplay.com",
  },
