...
import { FinalRule } from "@src/pages/rule/index";
import "./semifinal-match.scoped.css";

const FinalMatchModal = () => {
  const [visible, setVisible] = useModal(FinalMatchModal);
    ...
    <div className="modal-wrapper">
      <div className="content-wrapper">
        <div className="semifinal-modal-new">
          <span data-title />
          <h6 className="new-title">决赛规则</h6>
          <div className="competition">
            <FinalRule path="modal" />
          </div>
        </div>
...
export default FinalMatchModal;
