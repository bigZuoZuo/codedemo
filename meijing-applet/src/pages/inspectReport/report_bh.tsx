                    ...
                    <View className='replyinfoView'>
                        <View className='info_item'>
                            ...
                            <View className='item_right'>
                                <View className='radio-group radio-group--disabled' onClick={this.inspectChoose.bind(this, InspectInfoType.INCIDENT)}>
                        ...
                        {type === InspectInfoType.INCIDENT &&
                            <Block>
                                <View className='info_item'>
                                    <Text className='item_left required'>大气事件类型</Text>
                                    <View className='item_right'>
                                        <FpiPopupChoose range={pollutionTypeList} rangeKey='name' typeName='请选择大气事件类型' value={get(pollutionType, 'id', '')} onChange={this.onPollutionTypeChange.bind(this)}>
