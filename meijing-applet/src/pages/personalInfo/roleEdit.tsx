...
import {Role,listAllRoles} from '../../service/role'
...
export default class RoleEdit extends Component<RoleEditProps, RoleEditState> {
    ...
    async componentWillMount() {
        let {roleCodes} = this.$router.params;

        const resRoles = await listAllRoles();

        let roleList = resRoles.data && resRoles.data.entries || [];
