<template>
  <Header :class="getHeaderClass">
    ...
    <div :class="`${prefixCls}-left`">
      ...
      />
      <Info
        @clickSwitch="handleSwitchMerchant"
    ...
    <div :class="`${prefixCls}-action`">
      ...
      <SettingDrawer
        ...
        :class="`${prefixCls}-action__item`"
      />
      <MerchantSelect ref="merchantSelectRef" />
    </div>
  </Header>
</template>
<script lang="ts">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const getIsSupplier = computed(() => userStore.getRoleList.includes(RoleEnum.SUPPLIER))
    ...
    const merchantSelectRef = ref<any>(null)
    function handleSwitchMerchant() {
      unref(merchantSelectRef).showMerchantSelect()
    }
