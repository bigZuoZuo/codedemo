...
import ContentBigNumTitle from '@/components/ContentBigNumTitle';
import ContentMidNumTitle from '@/components/ContentMidNumTitle';
      ...
      <div className={styles.main}>
        <GridContent>
          ...
          <Card title="" style={{ marginBottom: 24 }} bordered={false}>
            <ContentBigNumTitle num={"01"} title={"订单详情"} style={{}}/>
            <ContentMidNumTitle num={"2.1"} title={"经营性信息"} style={{}}/>
            <div className="padding40">
              <Descriptions style={{ marginBottom: 24 }}>
                <Descriptions.Item span={12} label="用户姓名">付小小</Descriptions.Item>
                <Descriptions.Item span={12} label="会员卡号">32943898021309809423</Descriptions.Item>
                <Descriptions.Item span={12} label="身份证">3321944288191034921</Descriptions.Item>
                <Descriptions.Item span={12} label="联系方式">18112345678</Descriptions.Item>
                <Descriptions.Item span={12} label="联系地址">
                  曲丽丽 18100000000 浙江省杭州市西湖区黄姑山路工专路交叉路口
                </Descriptions.Item>
              </Descriptions>
              <Descriptions style={{ marginBottom: 24 }} bordered>
                <Descriptions.Item span={12} label="用户姓名">付小小</Descriptions.Item>
                <Descriptions.Item span={12} label="会员卡号">32943898021309809423</Descriptions.Item>
                <Descriptions.Item span={12} label="身份证">3321944288191034921</Descriptions.Item>
                <Descriptions.Item span={12} label="联系方式">18112345678</Descriptions.Item>
              ...
              <Descriptions style={{ marginBottom: 24 }} title="信息组">
                <Descriptions.Item span={12} label="某某数据">725</Descriptions.Item>
                <Descriptions.Item span={12} label="该数据更新时间">2017-08-08</Descriptions.Item>
